...
conv_llama_3 = Conversation(
    system="<|start_header_id|>system<|end_header_id|>\n\nA chat between a curious human and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers to the human's questions.", # You are a pirate chatbot who always responds in pirate speak!
    roles=("user", "assistant"),
    messages=(),
    offset=0,
