...
# python upload_checkpoint.py --repo $repo --checkpoint_path "/export/agentstudio-family/zixian/Mantis/checkpoints/Mantis-8B-siglip-llama3-pretraind/mllava_100k_8192/checkpoint-final" --upload_mode "upload_folder"
